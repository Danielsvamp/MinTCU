...
inline int32_t first_order_filter(uint8_t sample_count, int32_t new_val, int32_t last_val);
inline float first_order_filter_f(uint8_t sample_count, int32_t new_val, float last_val);
